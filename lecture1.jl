...
# ╔═╡ 95471854-def5-4c1b-86ec-33c6b9fa3efa
begin
	using Images
...
# ╔═╡ f48a4b88-4459-11ef-1e07-d7bc07ffc0d3
url = "https://i.imgur.com/VGPeJ6s.jpg"

# ╔═╡ f9a01439-2dc8-49df-a70f-40828fd01120
download(url, "philip.jpg")

# ╔═╡ 23fed5cd-67a1-4ea9-90e3-223258cf0da6
typeof(philip)

# ╔═╡ 5f9873a3-d1fc-4a89-9ea2-c2083d1903e8
# ╠═╡ disabled = true
#=╠═╡
color = RGB(1,1,0)
  ╠═╡ =#

# ╔═╡ e69a39ec-b2b3-4410-8d13-2096f311c33d
pixel = philip[100,400]

# ╔═╡ 27d0d185-5846-44ab-b59c-d0202ffd5065
typeof(pixel)

# ╔═╡ 33afd66a-f226-4343-ad62-ca381de976ca
philip[1:1000, 1:400]

# ╔═╡ 22b30bcd-4545-4fcc-a85a-1c60e08a4869
begin
	(h, w) = size(philip)
	head = philip[(h ÷ 2):h, (w ÷ 10): (9w ÷ 10)]
end

# ╔═╡ ad268028-ad8d-453a-bc0c-f38dcae3a009
two_heads = [head head]

# ╔═╡ bf4ceabb-5306-423d-9749-99695fc71d31
size(two_heads)

# ╔═╡ af86244d-79da-476c-b368-cbe5f85db2c6
size(head), typeof(head)

# ╔═╡ 4ac0390c-575b-4348-ab12-80dc6c5c3bf9
m = [
	head reverse(head, dims=2)
	reverse(head, dims=1) reverse(reverse(head, dims=1), dims=2)
]

# ╔═╡ 1aa8c0b3-6308-4d53-b2da-db4a84014658
typeof(m)

# ╔═╡ b05b8523-0d39-4ab8-9be1-2292aa39a4b2
new_phil = copy(head)

# ╔═╡ b01b454c-e081-444b-967d-2a9a0f46a93f
for i in 1:100
	for j in 1:300
...
# ╔═╡ f08392c4-0c7b-47c2-a387-d4c558abb7ce
new_phil

# ╔═╡ 660808e4-8674-48d2-80cc-b40731b3ab98
begin
...
# ╔═╡ 8e5556ae-d543-4bfa-94bc-381438c17b73
begin
	red = RGB(1,0,0)
	red.r, red.g, red.b
end

# ╔═╡ 23485861-1dcf-4df9-8097-401410700bf4
function redify(color)
	return RGB(color.r, 0, 0)
end

# ╔═╡ a1270f9f-5fcf-4254-9edb-a5c82d9cb3e8
begin
	color = RGB(0.8, 0.5, 0.2)
	[color, redify(color)]
end

# ╔═╡ 9a0f2a53-f767-4e45-a00e-bd2b3c2b9931
typeof(color)

# ╔═╡ 8b72b404-0361-4aa8-aaa2-f8a4b75c6e7e
typeof(color) == typeof(pixel)

# ╔═╡ 72b15ff5-727c-4dff-b8c7-3ae924feb994
typeof(color)

# ╔═╡ 97630bd4-2e53-4900-bc2e-6c8ee9377529
typeof([color])

# ╔═╡ ddc58454-e934-4035-b27f-89acb0605820
redify.(philip)

# ╔═╡ 989d0fa3-9d24-4ae5-91b2-82dde51ad644
decimate(image, ratio=5) = image[1:ratio:end, 1:ratio:end]

# ╔═╡ a7fb3e03-f41b-4b1b-b8a8-a7e7a794eb0c
begin
	poor_phil = decimate(new_phil)
	poor_phil
end

# ╔═╡ fad75923-684f-4bd7-b630-77014ef4778d
size(new_phil), size(poor_phil)
